...
public class PrefsFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        try{
            ...
            //CheckBoxPreference useBluetooth = (CheckBoxPreference)findPreference("use_bluetooth_unlock");
            //useBluetooth.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            //    @Override
            //    public boolean onPreferenceClick(Preference preference) {
            //        return false;
            //    }
    ...
    private void updatePreferences(boolean enabled){
        try{
            ...
            //Handler handler = UPDService.getHandler();
            //if(handler != null){
            //    Message msg = handler.obtainMessage(UPDService.UPDATE_PREFS);
